...
- **Peripherals:** Relays, buttons, sensors, and LEDs as specified in the `config.h` file.
...
-   **HydroControl-GE:** Provides a full dashboard of all connected modules, allows for the assignment of reservoirs to wells, and offers manual control over all pumps.

---
*This documentation was generated by an AI assistant based on the project's functional and technical specifications.*
